import{o as In,_ as Ve,d as bn,u as yn,a as wn}from"./B1HbKVNP.js";import{r as he,c as En,o as Tn,a as nt,b as g,d as Sn,t as fe,u as P,n as Cn,e as rt}from"./DD8WcxSZ.js";const An=()=>{};var it={};/**
 * @license
...
Measurement ID: G-8V4CC0302V`),a=async()=>{try{if(s.value=!0,i.value="",t.value="pending",r.value="Testing connection...",!e||!e.auth)throw new Error("Firebase not initialized");const c=e.auth;console.log("Firebase Auth:",c);const l=c.currentUser;console.log("Current User:",l),t.value="success",r.value="Firebase connection successful!"}catch(c){console.error("Firebase test error:",c),t.value="error",r.value="Connection failed",i.value=c.message}finally{s.value=!1}};return Tn(()=>{a()}),(c,l)=>(rt(),nt("div",no,[g("div",ro,[g("div",io,[g("div",so,[l[2]||(l[2]=g("h2",{class:"card-title"},"Firebase Test",-1)),g("div",oo,[g("div",null,[l[0]||(l[0]=g("h3",{class:"font-medium text-gray-900 mb-2"},"Firebase Configuration:",-1)),g("div",ao,[g("pre",null,fe(P(o)),1)])]),g("div",null,[l[1]||(l[1]=g("h3",{class:"font-medium text-gray-900 mb-2"},"Connection Test:",-1)),g("div",co,[g("div",lo,[g("div",{class:Cn(["w-3 h-3 rounded-full",P(t)==="success"?"bg-green-500":P(t)==="error"?"bg-red-500":"bg-yellow-500"])},null,2),g("span",null,fe(P(r)),1)])])]),g("button",{onClick:a,class:"btn btn-primary w-full",disabled:P(s)},fe(P(s)?"Testing...":"Test Firebase Connection"),9,uo),P(i)?(rt(),nt("div",ho,[g("span",null,fe(P(i)),1)])):Sn("",!0)])])])])]))}},_o=Object.freeze(Object.defineProperty({__proto__:null,default:fo},Symbol.toStringTag,{value:"Module"}));export{mo as f,_o as t};
