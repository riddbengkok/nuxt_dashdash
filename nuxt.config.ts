...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      tokenCheckInterval: parseInt(
        process.env.NUXT_PUBLIC_TOKEN_CHECK_INTERVAL || '300000'
      ), // 5 minutes
      tokenExpiryWarning: parseInt(
        process.env.NUXT_PUBLIC_TOKEN_EXPIRY_WARNING || '600000'
      ), // 10 minutes
      tokenExpiryThreshold: parseInt(
        process.env.NUXT_PUBLIC_TOKEN_EXPIRY_THRESHOLD || '300000'
      ), // 5 minutes
    },
  },
  ssr: false,
